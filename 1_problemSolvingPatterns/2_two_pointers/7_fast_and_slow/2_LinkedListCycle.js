...
Imagine we have a slow and a fast pointer to traverse the LinkedList. In each iteration, the slow pointer moves one step and the fast pointer moves two steps. This gives us two case:
...
const hasCycle = function(head) {
    ...
    while(fastPointer && fastPointer.next){   // look-ahead check cus fastPointer is obviously faster that
...
console.log("x", hasCycle(head))

head.next.next.next.next.next.next = head.next.next.next;
console.log("y", hasCycle(head))

head.next.next.next.next.next.next = head.next.next;
console.log("z", hasCycle(head))
...
const findCycleLength = function(head) {
    ...
    while(fastPointer && fastPointer.next){
        ...
        if(slowPointer === fastPointer){
            ...
            // and makd a single round-cicle move with another pointer, counterPointer, counting each step
