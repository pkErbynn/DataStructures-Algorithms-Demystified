...
// O(n^2)
console.log("k:", smallest_subarray_given_sum_bruteforce([2, 1, 5, 2, 3, 2], 7)); // Output: 2
console.log("k:", smallest_subarray_given_sum_bruteforce([2, 1, 5, 2, 8], 7));    // Output: 1
console.log("k:", smallest_subarray_given_sum_bruteforce([3, 4, 1, 1, 6], 8));    // Output: 3
